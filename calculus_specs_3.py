...
class constants(object):
    ...
    def sextupole_si_main(self, r0, x):
        self.p = 2  #(SI SEXTUPOLE - FAC)
        self.r0 = r0/1000
        self.x = x
        # sys spec - NORMAL
        self.normal_sys_monomials = np.array([4,6,8,14])
        self.normal_sys_relative_multipoles_at_r0 = np.array([-7.0e-5, -1.4e-4, -2.4e-3, +1.4e-3])

        # rms spec - NORMAL
        self.normal_rms_monomials = np.array([3,4,5,6,8,14])
        self.normal_rms_relative_multipoles_at_r0 = np.array([1.5,1.5,1.5,1.5,1.5,1.5])*1e-4
        ...
        # rms spec - SKEW
        self.skew_rms_monomials = np.array([3,4,5,6,8,14])
        self.skew_rms_relative_multipoles_at_r0 = np.array([0.5, 0.5, 0.5, 0.5, 0.5, 0.5])*1e-4

    def sextupole_si_ch(self, r0, x):
        self.p = 2  #(SI SEXTUPOLE - FAC)
        self.r0 = r0/1000
        self.x = x
        # sys spec - NORMAL
        self.normal_sys_monomials = np.array([4,6,8,10])
        self.normal_sys_relative_multipoles_at_r0 = np.array([+3.1e-1, +3.3e-2, -4.8e-2, +1.4e-2])

        # rms spec - NORMAL
        self.normal_rms_monomials = np.array([4,6,8,10])
        self.normal_rms_relative_multipoles_at_r0 = np.array([1.5,1.5,1.5,1.5])*1e-4
        ...
        # rms spec - SKEW
        self.skew_rms_monomials = np.array([4,6,8,10])
        self.skew_rms_relative_multipoles_at_r0 = np.array([0.5, 0.5, 0.5, 0.5])*1e-4

    def sextupole_si_cv(self, r0, x):
        self.p = 2  #(SI SEXTUPOLE - FAC)
        self.r0 = r0/1000
        self.x = x
        # sys spec - NORMAL
        self.normal_sys_monomials = np.array([4,6,8,10])
        self.normal_sys_relative_multipoles_at_r0 = np.array([+2.9e-1, -3.5e-3, +5.5e-2, -1.1e-2])
    ...
    def sextupole_si_qs(self, r0, x):
        self.p = 2  #(SI SEXTUPOLE - FAC)
        self.r0 = r0/1000
        self.x = x
        # sys spec - NORMAL
        self.normal_sys_monomials = np.array([3,7,9,13])
        self.normal_sys_relative_multipoles_at_r0 = np.array([-5.8e-1, 2.7e-3, 8.0e-3, 2.4e-3])

        # rms spec - NORMAL
        self.normal_rms_monomials = np.array([3,7,9,13])
        self.normal_rms_relative_multipoles_at_r0 = np.array([1.5,1.5,1.5,1.5])*1e-4
        ...
        # rms spec - SKEW
        self.skew_rms_monomials = np.array([3,7,9,13])
        self.skew_rms_relative_multipoles_at_r0 = np.array([0.5, 0.5, 0.5, 0.5])*1e-4
    ...
    def q14(self, r0, x):
        ...
        # sys spec - NORMAL
        self.normal_sys_monomials = np.array([5,9,13,17])
        self.normal_sys_relative_multipoles_at_r0 = np.array([-3.9e-4, 1.7e-3, -8.0e-4, +8.5e-5])

        # rms spec - NORMAL
        self.normal_rms_monomials = np.array([2,3,4,5,9,13,17])
        self.normal_rms_relative_multipoles_at_r0 = np.array([1.5,1.5,1.5,1.5,0,0,0])*1e-4
        ...
        # rms spec - SKEW
        self.skew_rms_monomials = np.array([2,3,4,5,9,13,17])
        self.skew_rms_relative_multipoles_at_r0 = np.array([0.5, 0.5, 0.5, 0.5, 0, 0, 0])*1e-4
    ...
    def q20(self, r0, x):
        ...
        # sys spec - NORMAL
        self.normal_sys_monomials = np.array([5,9,13,17])
        self.normal_sys_relative_multipoles_at_r0 = np.array([-4.1e-4, 1.7e-3, -7.7e-4, +5.9e-5])

        # rms spec - NORMAL
        self.normal_rms_monomials = np.array([2,3,4,5,9,13,17])
        self.normal_rms_relative_multipoles_at_r0 = np.array([1.5,1.5,1.5,1.5,1.5,1.5,1,5])*1e-4
        ...
        # rms spec - SKEW
        self.skew_rms_monomials = np.array([2,3,4,5,9,13,17])
        self.skew_rms_relative_multipoles_at_r0 = np.array([0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5])*1e-4
    ...
    def q30(self, r0, x):
        ...
        # sys spec - NORMAL
        self.normal_sys_monomials = np.array([5,9,13,17])
        self.normal_sys_relative_multipoles_at_r0 = np.array([-4.3e-4, 1.8e-3, -8.1e-4, +7.2e-5])
